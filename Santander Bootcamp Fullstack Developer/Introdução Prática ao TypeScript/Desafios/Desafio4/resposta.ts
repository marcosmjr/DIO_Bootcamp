...
searchButton.addEventListener('click', async () => {
  ...
  let listaDeFilmes = Object(await procurarFilme(query));
...
function preencherSenha() {
  ...
  password = Number(((document.getElementById('senha')) as HTMLInputElement).value);
  validateLoginButton();
}
...
async function criarRequestToken () {
  let result = Object(await HttpClient.get({
